...
import {
  AtlasProjectSelectorItem,
  AtlasSubjectSelectorItem,
} from "@/types/AtlasSelectorTypes";
...
export default function AtlasActionModal({
  subjects,
  projects,
  projectLinkSubjectGroup,
}: AtlasActionModalProps) {
        ...
        return (
          <>
            ...
            <ScrollArea className="flex-1 overflow-auto">
              <AtlasSelectProjectPane
                projectsGroupedBySubject={projectLinkSubjectGroup}
              />
            </ScrollArea>
          </>
        );
        ...
        return (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new top-level category for Projects.
              </DialogDescription>
            </DialogHeader>
