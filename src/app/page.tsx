export default function Home() {
  return (
    <div className="bg-background w-full h-full items-center flex flex-col gap-8">
      <h1 className="text-5xl text-foreground border-b-4 border-primary p-8">
        Welcome to the A.T.L.A.S. Development Center!
      </h1>
      <p className="text-s text-muted">
        Assistant Technology Leveraging Accessibility Systems
      </p>

      <p className="text-l text-foreground w-1/2 text-center">
        A.T.L.A.S. is a personal knowledge system designed to handle as much of
