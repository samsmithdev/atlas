...
import AtlasSelectFileForProjectPanel from "@/components/legacy/panels/AtlasSelectFileForProjectPanel";
import {
    AtlasFileListItem,
    AtlasFileListItemRecord,
    AtlasFileListType,
} from "@/types/AtlasListTypes";
...
export default async function AtlasFilesLayout({
  ...
  const fileListItemsRecord: AtlasFileListItemRecord = fetchedFiles.reduce(
    (accumulator, file) => {
  ...
  return (
    ...
    >
      ...
      >
        <AtlasSelectFileForProjectPanel
          fileList={Object.values(fileListItemsRecord)}
        />
      </div>
