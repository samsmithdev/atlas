...
export async function createSubjectTransactionDeprecated(
...
export async function createSubjectDirectDemo(
  name: string,
  shortcode: string,
  description?: string
) {
...
export async function createSubjectOriginalTesting(subjectData: {
  id?: string;
  shortcode: string;
  name: string;
  description?: string;
