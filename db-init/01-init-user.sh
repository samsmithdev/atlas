...
# We log into psql as the root user, then execute the SQL commands, DEV ONLY sets atlas as superuser for vector extension/future plugins, will change for prod
