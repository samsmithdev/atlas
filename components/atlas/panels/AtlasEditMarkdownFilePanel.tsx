...
interface AtlasEditMarkdownFilePanelProps {
    fileId: string;
    initialContent: any; // ANY WARNING: Best for tip tap content?
}

export default function AtlasEditMarkdownFilePanel({ fileId, initialContent }: AtlasEditMarkdownFilePanelProps) {
    ...
    return (
        <div className="flex flex-col gap-2 h-full w-full pb-4">
            <div className='text-sm text-gray-500 text-right'>
                Status: {saveStatus}
            </div>
            <div className='border border-gray-300 rounded-md p-4 min-h-[500px] flex-1'>
